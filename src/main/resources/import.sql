...
INSERT INTO usuario
(ativo, empresa_usuario, id, cpf, email, login, nome, senha) VALUES
(true, 1, 1, 05562849259, 'usuario1@gmail.com', 'usuario1', 'user 1', 'cBz32i3RfBAIaqKNkTfdDZLrqih7z94jKllRAMiOW+U+b3GTkGAVUJhWsP6LK8KfVkkei6cekKUJpS2bU7VqvQ=='),
(true, 2, 2, 123456, 'usuario2@gmail.com', 'usuario2', 'user 2', 'cBz32i3RfBAIaqKNkTfdDZLrqih7z94jKllRAMiOW+U+b3GTkGAVUJhWsP6LK8KfVkkei6cekKUJpS2bU7VqvQ=='),
(true, 3, 3, 1112323234, 'usuario3@gmail.com', 'usuario3', 'user 3', 'cBz32i3RfBAIaqKNkTfdDZLrqih7z94jKllRAMiOW+U+b3GTkGAVUJhWsP6LK8KfVkkei6cekKUJpS2bU7VqvQ==');
...
INSERT INTO categoria (empresa, id, nome, ativo) VALUES
                                                     ...
                                                     (1, 3, 'Categoria 3', true),
                                                     (1, 4, 'Categoria 4', true),
                                                     (1, 5, 'Categoria 5', true),
                                                     (1, 6, 'Categoria 6', true),
                                                     (1, 7, 'Categoria 7', true),
                                                     (1, 8, 'Categoria 8', true),
                                                     (1, 9, 'Categoria 9', true),
                                                     (1, 10, 'Categoria 10', true),
                                                     (1, 11, 'Categoria 11', true),
                                                     (1, 12, 'Categoria 12', true),
                                                     (1, 13, 'Categoria 13', true),
                                                     (1, 14, 'Categoria 14', true),
...
INSERT INTO produto(
	ativo, estoque, estoque_minimo, valor_compra, valor_venda, datainclusao, fornecedor_id, id, marca_produto, descricao, nome, empresa)
VALUES
(true, 100, 10, 10.00, 20.00, '2023-01-01', 1, 1, 1, 'Produto 1 - Descrição', 'Produto 1', 1),
(true, 100, 10, 15.00, 25.00, '2023-01-01', 1, 2, 2, 'Produto 2 - Descrição', 'Produto 2', 1),
(true, 100, 10, 20.00, 30.00, '2023-01-01', 2, 3, 3, 'Produto 3 - Descrição', 'Produto 3', 1);
